...
| `ADR-009-effectiveness-evidence-quality.md` | Which effectiveness-evidence sources are permitted to support a full spend-sufficiency conclusion. | Pending — proposed evidence/scenario contract |
